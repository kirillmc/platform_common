...
type NamedExecer interface {
	ScanOneContext(ctx context.Context, dest interface{}, q Query, logger zap.Logger, args ...interface{}) error
	ScanAllContext(ctx context.Context, dest interface{}, q Query, logger zap.Logger, args ...interface{}) error
}

// QueryExecer - интерфейс для работы с обычными запросами - по сути обертка над pgx
type QueryExecer interface {
	ExecContext(ctx context.Context, q Query, logger zap.Logger, args ...interface{}) (pgconn.CommandTag, error)
	QueryContext(ctx context.Context, q Query, logger zap.Logger, args ...interface{}) (pgx.Rows, error)
	QueryRowContext(ctx context.Context, q Query, logger zap.Logger, args ...interface{}) pgx.Row
}
